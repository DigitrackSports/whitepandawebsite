        ...
        <div class="row tabContainer">
            <div class="col-md-12">
                <div class="services-btn-container">
                    <ul class="tabs">
                        <li>
                            <a class="active showBox" data-content="tab1" href="javascript:void(0);">
                                Business Process Outsourcing
                            </a>
                        </li>
                        <li>
                            <a class="showBox" data-content="tab2" href="javascript:void(0);">Application Development</a>
                        </li>
                        <li>
                            <a class="showBox" data-content="tab3" href="javascript:void(0);">IT and Managed Services</a>
                        </li>
                        <li>
                            <a class="showBox" data-content="tab4" href="javascript:void(0);">Cyber Security</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<div class="faqs-area style-one">
    <div class="container">
        <div class="row add-faqs-bg align-items-center">
            <div class="col-lg-6">
                ...
                <div class="faqs-container">
                    <div class="faq-singular">
                        ...
                        <div class="faq-answer">
                            <div class="desc">
                                Lorem ipsum dolor sit amet, consectetur adipisicing awesom.
                                Optio, neque qui velit. Magni dolorum quidem ipsam also as
                                eligendi, totam, facilis laudantium.
                            </div>
                        </div>
                    </div>
                    <div class="faq-singular">
...
<div class="portfolio-area style-three">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="section-title center style-two">
                    <!-- <h4>Our Project</h4> -->
                    <h1>Our Recently Launched Projects</h1>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="portfolio-list-3 owl-carousel">
                <div class="col-lg-12">
...
<div class="teastimonial-area style-three">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="section-title center style-two">
                    <!-- <h4>Testimonial</h4> -->
                    <h1>What our Valuable Clients Say</h1>
                </div>
            </div>
        </div>
        <div class="row">
