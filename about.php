        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="contact-content">
                    ...
                    <h1>+91-9999999999</h1>
                    <p>Got an idea? Our team of skilled developers can turn it into a reality. Share your vision, and we'll bring it to life. Contact us today.</p>
                </div>
                <div class="toptech-button inner-style">
                    <a href="contact">Let’s Talk<i class="bi bi-arrow-right-short"></i></a>
                </div>
            </div>
            <div class="col-lg-6">
